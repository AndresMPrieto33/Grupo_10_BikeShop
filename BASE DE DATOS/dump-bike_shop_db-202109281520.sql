...
CREATE TABLE `products` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_dbf88b83-341d-4e9d-b051-1e986fcfc1e0` (`category_id`),
  KEY `FK_97bf2396-1e9d-4b13-9056-c38fd96b9a95` (`product_detail_id`),
  KEY `FK_fa1ff422-c361-496f-bbf8-75a74a8628a7` (`stock_id`),
  CONSTRAINT `FK_97bf2396-1e9d-4b13-9056-c38fd96b9a95` FOREIGN KEY (`product_detail_id`) REFERENCES `product_detail` (`id`),
  CONSTRAINT `FK_dbf88b83-341d-4e9d-b051-1e986fcfc1e0` FOREIGN KEY (`category_id`) REFERENCES `category` (`id`),
  CONSTRAINT `FK_fa1ff422-c361-496f-bbf8-75a74a8628a7` FOREIGN KEY (`stock_id`) REFERENCES `stock` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-09-28 15:20:15
